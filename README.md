...
- [x] (NEW!) Локализация языка бота
  - Доступные языки :gb: :de: :ru: :tr: :it: :es: :indonesia: :netherlands:
...
| `BOT_LANGUAGE`                     | Язык общих сообщений бота. В настоящее время доступны: `en`, `de`, `ru`, `tr`, `it`, `es`, `id`, `nl`.  [Contribute with additional translations](https://github.com/n3d1117/chatgpt-telegram-bot/discussions/219) | `en`                               |
